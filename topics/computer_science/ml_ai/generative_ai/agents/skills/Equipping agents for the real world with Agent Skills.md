...
tags:
  - gen_ai
  - gen_ai/agents
created: 2026-01-23T12:41
modified: 2026-01-23T12:57
published:
sources:
...
**Progressive disclosure** is the core design principle ([[Core principle - Progressive Disclosure]]) that makes Agent Skills flexible and scalable. Like a well-organized manual that starts with a table of contents, then specific chapters, and finally a detailed appendix, skills let Claude load information only as needed:
...
Agent Skills are [supported today](https://www.anthropic.com/news/skills) across [Claude.ai](http://claude.ai/redirect/website.v1.8d070a17-e400-44c1-a9da-84fb5775f18d), Claude Code, the Claude Agent SDK, and the Claude Developer Platform.
